...
# For LTCC dataset
python -m torch.distributed.launch --nproc_per_node=1 main.py --dataset ltcc --cfg configs/res50_cels_cal.yaml  #
# For PRCC dataset
#CUDA_LAUNCH_BLOCKING=1 python -m torch.distributed.launch --nproc_per_node=1 main.py --dataset prcc --cfg configs/res50_cels_cal.yaml  #
