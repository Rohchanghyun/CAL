...
# For LTCC dataset
#python -m torch.distributed.launch --nproc_per_node=1 main.py --dataset ltcc --cfg configs/res50_cels_cal.yaml --gpu 1 #
# For PRCC dataset
#python -m torch.distributed.launch --nproc_per_node=1 main.py --dataset prcc --cfg configs/res50_cels_cal.yaml --gpu 1 #

# Baseline
# For LTCC dataset 
python -m torch.distributed.launch --nproc_per_node=1 main.py --dataset ltcc --cfg configs/res50_cels_base.yaml --gpu 0 #
# For PRCC dataset
python -m torch.distributed.launch --nproc_per_node=1 main.py --dataset prcc --cfg configs/res50_cels_base.yaml --gpu 0 #
